...
*Answer: 61.7% of adults in my sample think climate change affects their local community.*
...
*Answer: I would expect most of the other students' sample proportion to be similar to mine, because the 95% confidence interval of my sample (49.4%, 74.0%) includes the population proportion of 62%.*

```{r}
samp_p_hat <- samp_yes_summ |> 
  pull(p_hat)

CI = c(samp_p_hat - (1.96 * (sqrt(samp_p_hat * (1-samp_p_hat) / 60))),
       samp_p_hat + (1.96 * (sqrt(samp_p_hat * (1-samp_p_hat) / 60)))) |> 
  round(3)
CI
```
...
*Answer: 95% confidence means we are 95% confident that the population proportion falls with the confidence interval.*
...
*Answer: My bootstrap confidence interval (50.0%, 73.3%) does capture the population proportion of 62%.*
...
*Answer: I would expect 95% of my classmates to capture the population proportion, because the 95% confidence interval of a sampling distribution gives us 95% confidence that another sampling distribution of 95% from the same population will also contain the population mean.*
...
*Answer: 94% of the constructed confidence intervals contained the population mean, which is not equal to the 95% confidence interval that was set. This is both because the 95% confidence interval is not not a guaranteed interval, but rather an estimate.*
...
*Answer: At an interval of 90%, for example, the distribution would be narrower. The would be a more precise estimation, but also contain more errors. On the contrast, an interval of 99% would be wider, less precise, and contain less errors.*
...
*Answer: We can be 99% confident that the population mean falls in the interval (51.7%, 79.2%).*

```{r samp-bootstrap-99-ci}
...
*Answer: Using the app, I found the 98% of my simulations contained the population proportion This is somewhat close but not equal to the 99% confidence interval that I set.*
...
1.  Lastly, try one more (different) confidence level. First, state how you expect the
    ...
    and calculate the proportion of intervals that capture the true population 
    proportion.

**Insert your answer here**

*Answer: I chose a confidence interval of 90%, so expect the width of this interval to be the narrowist out of the previous tests of 95% and 99%. At a 90% confidence interval, I have 90% confidence that the population proportion falls in the interval (50.0%, 73.3%). Furthermore, we can expect that 90% of 90% CI sampling distributions from this population will also contain the population proportion. Using the app, I found that 92% of my simulations contained the population proportion.*
...
*Answer: As the sample size increases, the widths of the intervals decrease.*
...
*Answer: There is no noticeable change in the width of the intervals as you increase the number of bootstrap samples.*
