...
def exercise01():
    ...
    df1 = pd.DataFrame({'Name': ['Alice', 'Bob', 'Charlie', 'David', 'Eve'], 'Age': [25, 30, 22, 35, 28]})
...
def exercise02():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df2 = pd.read_csv('/Users/alex/SPS_MS_DS/DATA_602/data.csv')
    print(df2.head())
    # ------ Place code above here /\ /\ /\ ------
    return df2
...
def exercise06():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df6 = pd.read_excel('/Users/alex/SPS_MS_DS/DATA_602/data.xlsx')
    # ------ Place code above here /\ /\ /\ ------
    return df6
